...
public class DefaultRpcProtocol {
    ...
    public static RpcByteBuffer encode(Object message,RpcByteBuffer bytebufferWrapper) throws Exception {
        ...
        return RcfProtocolFactory.getProtocol(type).encode(message, bytebufferWrapper);
    }
    ...
    public static Object decode(RpcByteBuffer wrapper, Object errorObject) throws Exception {
        ...
        if(version == 1){
            ...
            return RcfProtocolFactory.getProtocol(type).decode(wrapper, errorObject, new int[]{originPos});
        }else{
