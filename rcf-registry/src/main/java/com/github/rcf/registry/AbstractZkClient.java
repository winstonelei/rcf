...
public abstract class AbstractZkClient<TargetChildListener, TargetDataListener> implements ZkClient {
    ...
    private static final Log logger = LogFactory.getLog(AbstractZkClient.class);
    ...
    public String create(String path, String data, boolean ephemeral, boolean sequential) {
        int i = path.lastIndexOf('/');
        if (i > 0) {
    ...
    protected abstract String createPersistent(String path, String data, boolean sequential);

    protected abstract String createEphemeral(String path, boolean sequential);

    protected abstract String createEphemeral(String path, String data, boolean sequential);
